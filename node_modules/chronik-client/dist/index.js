...
class WsEndpoint {
    ...
    unsubscribe(scriptType, scriptPayload) {
        var _a;
        this._subs = this._subs.filter(sub => sub.scriptType !== scriptType || sub.scriptPayload !== scriptPayload);
        if (((_a = this._ws) === null || _a === void 0 ? void 0 : _a.readyState) === isomorphic_ws_1.default.OPEN) {
...
function convertToUtxo(utxo) {
    ...
    return {
        ...
        value: utxo.value,
        slpMeta: utxo.slpMeta !== undefined ? convertToSlpMeta(utxo.slpMeta) : undefined,
...
function convertToToken(token) {
    ...
    return {
        ...
        block: token.block !== undefined ? convertToBlockMeta(token.block) : undefined,
...
function convertToTxInput(input) {
    ...
    return {
        ...
        outputScript: input.outputScript.length > 0 ? (0, hex_1.toHex)(input.outputScript) : undefined,
        value: input.value,
        sequenceNo: input.sequenceNo,
        slpBurn: input.slpBurn !== undefined ? convertToSlpBurn(input.slpBurn) : undefined,
