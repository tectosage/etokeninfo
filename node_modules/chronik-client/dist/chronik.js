...
exports.Error = exports.MsgBlockDisconnected = exports.MsgBlockConnected = exports.MsgReorg = exports.MsgConfirmed = exports.MsgRemovedFromMempool = exports.MsgAddedToMempool = exports.SubscribeMsg = exports.Subscription = exports.UtxoState = exports.SlpGenesisInfo = exports.SlpBurn = exports.SlpToken = exports.OutPoint = exports.BlockMetadata = exports.TxOutput = exports.TxInput = exports.TokenStats = exports.SlpMeta = exports.SlpTxData = exports.Blocks = exports.Utxos = exports.TxHistoryPage = exports.ScriptUtxos = exports.Block = exports.BlockDetails = exports.BlockInfo = exports.Token = exports.Utxo = exports.Tx = exports.BlockchainInfo = exports.BroadcastTxsResponse = exports.BroadcastTxsRequest = exports.BroadcastTxResponse = exports.BroadcastTxRequest = exports.ValidateUtxoResponse = exports.ValidateUtxoRequest = exports.utxoStateVariantToJSON = exports.utxoStateVariantFromJSON = exports.UtxoStateVariant = exports.networkToJSON = exports.networkFromJSON = exports.Network = exports.slpTxTypeToJSON = exports.slpTxTypeFromJSON = exports.SlpTxType = exports.slpTokenTypeToJSON = exports.slpTokenTypeFromJSON = exports.SlpTokenType = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.BlockchainInfo = {
    ...
    toJSON(message) {
        ...
        message.tipHash !== undefined &&
            (obj.tipHash = base64FromBytes(message.tipHash !== undefined ? message.tipHash : new Uint8Array()));
...
exports.Tx = {
    ...
    fromPartial(object) {
        ...
        message.outputs = ((_d = object.outputs) === null || _d === void 0 ? void 0 : _d.map(e => exports.TxOutput.fromPartial(e))) || [];
        ...
        message.network = (_k = object.network) !== null && _k !== void 0 ? _k : 0;
        return message;
    },
};
...
exports.BlockInfo = {
    ...
    toJSON(message) {
        ...
        message.prevHash !== undefined &&
            (obj.prevHash = base64FromBytes(message.prevHash !== undefined ? message.prevHash : new Uint8Array()));
...
exports.Blocks = {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseBlocks();
        message.blocks = ((_a = object.blocks) === null || _a === void 0 ? void 0 : _a.map(e => exports.BlockInfo.fromPartial(e))) || [];
        return message;
    },
};
...
exports.SlpMeta = {
    ...
    toJSON(message) {
        ...
        message.tokenId !== undefined &&
            (obj.tokenId = base64FromBytes(message.tokenId !== undefined ? message.tokenId : new Uint8Array()));
...
exports.SlpBurn = {
    ...
    fromJSON(object) {
        return {
            token: isSet(object.token) ? exports.SlpToken.fromJSON(object.token) : undefined,
            tokenId: isSet(object.tokenId)
                ? bytesFromBase64(object.tokenId)
                : new Uint8Array(),
        };
    ...
    toJSON(message) {
        ...
        message.token !== undefined &&
            (obj.token = message.token ? exports.SlpToken.toJSON(message.token) : undefined);
        message.tokenId !== undefined &&
            (obj.tokenId = base64FromBytes(message.tokenId !== undefined ? message.tokenId : new Uint8Array()));
        return obj;
    },
...
exports.SlpGenesisInfo = {
    ...
    toJSON(message) {
        ...
        message.tokenName !== undefined &&
            (obj.tokenName = base64FromBytes(message.tokenName !== undefined ? message.tokenName : new Uint8Array()));
    ...
    fromPartial(object) {
        ...
        message.tokenDocumentHash = (_d = object.tokenDocumentHash) !== null && _d !== void 0 ? _d : new Uint8Array();
...
exports.SubscribeMsg = {
    ...
    fromJSON(object) {
        return {
            ...
            Confirmed: isSet(object.Confirmed)
                ...
                : undefined,
            Reorg: isSet(object.Reorg) ? exports.MsgReorg.fromJSON(object.Reorg) : undefined,
    ...
    toJSON(message) {
        ...
        message.error !== undefined &&
            (obj.error = message.error ? exports.Error.toJSON(message.error) : undefined);
        ...
        message.Reorg !== undefined &&
            (obj.Reorg = message.Reorg ? exports.MsgReorg.toJSON(message.Reorg) : undefined);
